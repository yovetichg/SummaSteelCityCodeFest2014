    ...
    <table>
        ...
        <c:forEach items="${persons}" var="person">
            <tr>
                ...
                <td><a
                        href="/api/person/edit/<c:out value="${person.id}"/>"><spring:message code="person.edit.link.label"/></a></td>
                <td><a href="/api/person/delete/<c:out value="${person.id}"/>"><spring:message code="person.delete.link.label"/></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
