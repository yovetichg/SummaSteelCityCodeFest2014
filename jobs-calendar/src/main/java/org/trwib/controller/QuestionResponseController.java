...
public class QuestionResponseController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/question/{questionId}/{yesNo}", method = RequestMethod.GET)
    public QuestionResponseDto nextQuestion(@PathVariable("questionId") Long questionId,
        ...
        return new QuestionResponseDto(next);
    }
